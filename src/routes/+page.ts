		...
		projects: [
			{
				...
				description:
					'Implementation of design, whole page development, and maintenance between 2020 - 2021',
			...
			},
			{
				name: 'Decydownik',
				description:
					'Slight backend modifications, language select, image login, and long-term deciding functionality',
			...
			},
			{
				...
				description:
					'Partially Implementing design, backend and frontend functionality. *Page access is only available for registered OneReach users.',
			...
			},
			{
				name: 'Kapitales',
				description:
					'Product customizer Front-end, backend; implementing new customizer UI, saving user customization.',
